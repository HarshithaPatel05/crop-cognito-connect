...
const ROLES = [
  {
    ...
    icon: "👨‍🌾", label: "Farmer", desc: "Manage crops & harvest", path: "/farmer",
  ...
  {
    id: "buyer" as AppRole,
    icon: "🛒", label: "Buyer", desc: "Browse & pre-book crops", path: "/marketplace",
  ...
  },
  {
    ...
    icon: "🚚", label: "Transport", desc: "Manage vehicles & logistics", path: "/transport",
  ...
  },
  {
    ...
    icon: "🏪", label: "Storage", desc: "Warehouses & cold storage", path: "/storage",
  ...
  },
  {
    ...
    icon: "💰", label: "Finance", desc: "Loans & payment schemes", path: "/finance",
    color: "border-secondary/40 bg-secondary/5 hover:border-secondary hover:bg-secondary/10",
    activeColor: "border-secondary bg-secondary/15 ring-2 ring-secondary/30",
  ...
  {
    id: "fpo" as AppRole,
    icon: "🏛️", label: "FPO / Agri Officer", desc: "Monitor clusters & certify", path: "/fpo",
  ...
  },
  {
    ...
    icon: "📊", label: "Analyst", desc: "Market insights & forecasts", path: "/analytics",
    color: "border-agro-sky/40 bg-agro-sky/5 hover:border-agro-sky hover:bg-agro-sky/10",
    activeColor: "border-agro-sky bg-agro-sky/15 ring-2 ring-agro-sky/30",
  ...
  {
    id: "admin" as AppRole,
    icon: "⚙️", label: "Admin", desc: "Platform overview & control", path: "/admin",
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      {/* Header */}
      <div className="py-5 px-4 flex justify-center border-b border-border bg-card">
      ...
      <div className="flex-1 flex items-start justify-center px-4 py-10">
        <div className="w-full max-w-2xl">
          <div className="text-center mb-8">
            <Badge className="mb-3 bg-primary/10 text-primary border-primary/20">🔐 Secure Login</Badge>
            <h1 className="text-3xl font-bold text-foreground mb-2">Welcome to AgroSense</h1>
            <p className="text-muted-foreground text-sm">Select your role and sign in to access your personalised dashboard.</p>
          </div>
          ...
          <Card className="border-border shadow-sm">
            <CardContent className="pt-6 pb-6 px-6">
              ...
              {selectedRoleData && (
                <div className="mb-4 flex items-center gap-3 py-2.5 px-3 rounded-lg bg-primary/5 border border-primary/20">
                  <span className="text-xl">{selectedRoleData.icon}</span>
                  <div>
                    <div className="text-sm text-primary font-semibold">{selectedRoleData.label} Portal</div>
                    <div className="text-xs text-muted-foreground">{selectedRoleData.desc}</div>
                  </div>
                </div>
              )}
